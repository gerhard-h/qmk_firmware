...
[_L0] = LAYOUT_planck_mit(    
                                   ...
                                   MT(MOD_LCTL ,KC_TAB),      TD(TD_A_UML),   TD(TD_SS_UML),          TD(TD_D),           F_LSHFT,       TD(TD_G),      TD(TD_H),           N_RSHFT,           TD(TD_T),        TD(TD_L), MT(MOD_LALT, KC_K),    MT(MOD_LCTL,KC_ENT),
...
// test mt 
 ...
 [_GAME] = LAYOUT_planck_mit(    
     KC_ESC,     KC_Q,        KC_W,          KC_E,          KC_R,          KC_J,           KC_Y,        TD(TD_U_UML),           KC_I,     TD(TD_O_UML),               KC_P,    KC_BSPC,
     KC_TAB, TD(TD_A_UML), TD(TD_SS_UML),  LCTL_T(KC_D),  LSFT_T(KC_F),          KC_G,           KC_H,      RSFT_T(KC_N),   LCTL_T(KC_T),        KC_L,       LALT_T(KC_K),    KC_ENT,
