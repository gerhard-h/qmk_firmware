...
rgb_matrix_set_color(33, 150, 10, 10); // cursor keys
rgb_matrix_set_color(44, 150, 10, 10);
rgb_matrix_set_color(45, 150, 10, 10);
rgb_matrix_set_color(46, 150, 10, 10);
break;
case 1:
...
rgb_matrix_set_color(34, 150, 10, 10); // cursor keys
rgb_matrix_set_color(44, 150, 10, 10);
rgb_matrix_set_color(45, 150, 10, 10);
rgb_matrix_set_color(46, 150, 10, 10);
break;
...
rgb_matrix_set_color(45, 150, 10, 10); // volume
rgb_matrix_set_color(46, 150, 10, 10);
break;
}
}
...
#   endif
    ...
    uint16_t keycode5 = ((dance_user_data_t*)user_data)->keycode5;
    switch (atap_state.state) {
        case TD_DOUBLE_HOLD:
            tap_code16(keycode3);
            tap_code16(keycode4);
...
#            endif
        ...
        case TD_DOUBLE_SINGLE_TAP:
             if (keycode5) {tap_code16(keycode5); break;}
        default:
...
#   endif
    ...
    switch (atap_state.state) {
        ...
        case TD_SINGLE_HOLD:
             if (get_mods() & (MOD_MASK_GUI | MOD_MASK_ALT | MOD_MASK_CTRL)) {tap_code(keycode); break;}
#            ifdef AUTO_SHIFT_ENABLE
...
qk_tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_C] = ACTION_TAP_DANCE_FN_ADVANCED_USER(shortcut_dance_each, shortcut_dance_finished, shortcut_dance_reset, &((dance_user_data_t){KC_C, S(KC_6),A(C(KC_8)), A(C(KC_9)), C(KC_C)})),
    ...
    [TD_P] = ACTION_TAP_DANCE_FN_ADVANCED_USER(NULL, dance_norepeat_finished, dance_norepeat_reset, &((dance_user_data_t){KC_P, S(KC_P), ALGR(KC_RBRC)})),
    [TD_T] = ACTION_TAP_DANCE_FN_ADVANCED_USER(NULL, dance_norepeat_finished, dance_norepeat_reset, &((dance_user_data_t){KC_T, S(KC_T), S(KC_9)})),
